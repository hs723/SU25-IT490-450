...
curl -fsSL https://tailscale.com/install.sh | sh && sudo tailscale up --auth-key=tskey-auth-kgAZAb9ena11CNTRL-B1cAMn6q9BihURBr4qq8BiPebd9CUcTd \  --hostname=dev-db-404notfounders